 ...
 * tags:
 *   name: Games
 *   description: Poker game management
 */
 ...
 *     responses:
 *         200:
 *           description: An object with table and payment session id after creating a new game
 *           content:
 *             application/json:
 *               schema:
 *                 type: object
...
export async function create(
  ...
  try {
    ...
    return response.json({ error: (e as any).message });
  }
}
