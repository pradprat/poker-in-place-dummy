 ...
 *                    type: string
 *         200:
 *           description: An object with table and payment session id after extending the table for user
 *           content:
 *             application/json:
 *               schema:
 *                 type: object
 ...
 *                    type: string
 *         200:
 *           description: An object with boolean value and time after confirming the extendsion of table for user
 *           content:
 *             application/json:
 *               schema:
 *                 type: object
